...
class Transaction:
    ...
    nb_transactions_heure: int = 0
    est_nouveau_beneficiaire: bool = False
...
def appliquer_toutes_les_regles(tx: Transaction) -> List[ResultatRegle]:
    regles = [
        regle_montant_eleve,
